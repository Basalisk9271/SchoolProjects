...
// the use of the constructors from BinaryTreeBasis
  ...
  }//End protected preorder()

  public void postorder()
  {
	postorder(root);
  }//End public postorder()
  ...
  private boolean duplicateCheck(TreeNode t1, TreeNode t2)
  {
    if (t1 == null && t2 == null)
      ...
      return false;
    else return ((KeyedItem)t1.getItem() == (KeyedItem)t2.getItem()) && duplicateCheck(t1.getLeft(),t2.getLeft()) &&
