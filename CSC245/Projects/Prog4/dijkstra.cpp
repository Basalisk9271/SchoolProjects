...
//will use in some capacity or other.
{
    ...
    if (argc != 2)
    {
        cout << "\nError -- Command Line Inputs not correct!\nPlease try again.\n" << endl;
        exit(1);
    }//Exception handling for incorrect command line arguments
    ...
    if (!fileIn.is_open())
    {
        cout << "\nThe File Name included is incorrect.\nPlease try again.\n" << endl;
        exit(1);
    }//Exception handling for incorrect file name
